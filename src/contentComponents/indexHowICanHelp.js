...
const listing = [
  ...
  "w zyskaniu albo odzyskaniu radości, spokoju, swobody i satysfakcji z życia. Motywacją do podjęcia pracy terapeutycznej może być chronicznie obniżony nastrój, stany lękowe, poczucie wyobcowania, wstyd (lub perfekcjonizm), trudności w relacjach, uporczywy stres, problemy ze snem itd. “To o co nam chodzi,pisze F. Perls, twórca terapii Gestalt – “to dojrzewanie człowieka, usuwanie blokad, które przeszkadzają mu w staniu na własnych nogach. Staramy się pomóc w przejściu ze wsparcia środowiska na samo-wsparcie (…) celem terapii jest sprawić, by pacjent był niezależny od innych oraz by odkrył od samego początku, że jest w stanie zrobić wiele rzeczy, o wiele więcej, niż uważa, że potrafi”.",
];
