...
const IndexTherapyDetails = () => (
  <div className="my-5">
    ...
    <p>
      Sesje odbywają się co tydzień, o ustalonej godzinie, najczęściej raz w
      tygodniu.
    </p>
    <p> Swoją pracę poddaję superwizji.</p>
    <p>
      Jeśli ze względu na stan zdrowia, nie możesz sobie pozwolić na pokrycie
      kosztu terapii, powiedz mi o tym. Spróbujemy wspólnie znaleźć rozwiązanie.
    </p>
  </div>
);
